...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
    <div class="w3-container" style="margin-top:60px" id="showcase">
        <h1 class="w3-jumbo" id="main"><b>Green Alert</b></h1>
        <h2 style="font-family: 'Dancing Script'">It is perfectly fine to take the precautions!!</h2>
        <p>Your location will be shared.</p>
    </div>
    <div class="w3-row-padding">

        <div class="w3-half Container">
        <div id="map"></div>
          <p style="float:right;position:relative;top:-300px;left:500px;padding:10px" class="success"><strong>Location has been send <br> and they will call you soon!!</strong></p>
        </div>
...
<?php
  //$d=$_SESSION['user'];
mysqli_query($conn,"UPDATE location set green=0 WHERE User_ID='$us'");
?>
